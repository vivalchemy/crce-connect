...
<div>
  <div class="bg-foreground text-background">
    ...
    >
      <div
        class="relative top-1/3 inset-0 flex flex-col justify-center items-center text-white"
      >
        <!-- Heading -->
        <h1 class=" mx-56 text-6xl text-background font-bold text-center">
          Fr. Conceicao Rodrigues College of Engineering
        </h1>

        <!-- Subheading -->
        <p class="pt-4 text-2xl text-background text-left">
          Moulding Engineers Who Can Build Nation
        </p>
      </div>
    </div>
  </div>
